							...
							<div class="span12">
								...
								<div class="portlet box blue">
									<div class="portlet-title">
										<h4><i class="icon-edit"></i>TimeTable List</h4>
									</div>
									<div class="portlet-body">
										<div class="clearfix">
											<div class="btn-group">
												<a href="/timetablecreate">
										...
										<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
											<thead>
												<tr>
													...
													<th class="span9">Lecturer</th>
													<th class="span9">Days</th>
													<th>Edit</th>
													<th>Delete</th>
												</tr>
											</thead>
												...
												@if($response)
													@foreach($response as $timetable)
														<tr class="">
															...
															<td><a class="edit" href="/timetable-update/{{$timetable->id}}">Edit</a></td>
															<td><a class="delete" href="/deletetimetable/{{$timetable->id}}">Delete</a></td>
														</tr>	
													@endforeach
												@endif
