               ...
               <div class="row-fluid">
                  <div class="span12">
                     ...
                     <ul class="breadcrumb">
                        ...
                        <li><a href="#">TimeTable Create</a></li>
                     </ul>
                  </div>
               </div>
            <!-- END PAGE HEADER-->
                  ...
                  <div class="span12">
                     <div class="portlet box blue" id="form_wizard_1">
                        <div class="portlet-title">
                           <h4>
                              <i class="icon-reorder"></i> TimeTable Create <!-- - <span class="step-title">Step 1 of 3</span> -->
                           </h4>
                           
                        </div>
                        <div class="portlet-body form">
                           <form action="/addtimetable" class="form-horizontal" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="tab-content">
                                    <div class="tab-pane active" id="tab1">
                                                ...
                                                <div class="controls">
                                                   <select name="s_name" id='seminar' class="m-wrap span7 chosen">
                                                         @foreach($response as $seminar)
                                                            <option value="{{$seminar->id}}">{{$seminar->name .' ('.$seminar->code_no.')'}}</option>
                                                         @endforeach
                                                   </select>    
                                                </div>
                                             </div>
                                       ...
                                       <div class="control-group">
                                          ...
                                          <div class="controls">
                                             <input type="text" class="span7 m-wrap" name="venue" required placeholder="Subjects" />
                                          </div>
                                       </div>
                                       <div class="control-group">
                                          <label class="control-label">Lecturer</label>
                                          <div class="controls">
                                             <input type="text" class="span7 m-wrap" name="lecturer" required placeholder="Lecturer Name" />
                                          </div>
                                       </div>
                                       <div class="row-fluid">
                                          <div class="span12">
