            ...
            <!-- BEGIN PAGE CONTENT-->
               <div class="row-fluid">
                  <div class="responsive span10" data-tablet="span8" data-desktop="span8">
                     <form id="addnew-form" class="horizontal-form" action = "/adduser" method= "post" enctype="multipart/form-data">    
                              ...
                              <div class="row-fluid">
                                 <div class="span8">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input name="name_mm" class="m-wrap span12" placeholder="Mg Mg" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row-fluid">
                                 <div class="span8">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input name="name_jp" class="m-wrap span12" placeholder="Mg Mg" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row-fluid">
                                 <div class="span8">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input name="email" class="m-wrap span12" placeholder="MgMg@gmail.com" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </div>
