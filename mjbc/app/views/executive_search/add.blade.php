               ...
               <div class="row-fluid">
                  <div class="span12">
                     ...
                     <ul class="breadcrumb">
                        ...
                        <li><a href="#">Executive Search Create</a></li>
                     </ul>
                  </div>
               </div>
            <!-- END PAGE HEADER-->
                  ...
                  <div class="span12">
                     <div class="portlet box blue" id="form_wizard_1">
                        <div class="portlet-title">
                           <h4>
                              <i class="icon-reorder"></i> Executive Search Create <!-- - <span class="step-title">Step 1 of 3</span> -->
                           </h4>
                           
                        </div>
                        <div class="portlet-body form">
                           <form action="/adde_search" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-pane active" id="tab1">
                                      ...
                                      <div class="control-group">
                                          ...
                                          <div class="span12">
                                                   ...
                                                   <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                         <div class="input-append date " >
                                                            <input  id="calendar_2" name="sdate" type="text" value="12/02/2014"/><span class="add-on"><i class="icon-calendar"></i></span>
                                                         </div>
                                                      </div>
                                                   </div>
                                             </div>
                                             <div class="span4">
                                                   <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                         <div class="input-append date " >
                                                            <input  id="calendar_1" name="edate" type="text" value="12/02/2014"/><span class="add-on"><i class="icon-calendar"></i></span>
                                                         </div>
                                                      </div>
                                                   </div>
                                             </div>
                                          ...
                                          <div class="span12">
                                                   ...
                                                   <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                         <div class="input-append">
                                                            <input type="text" id="clockface_2" value="14:30" name="stime" class="m-wrap small" readonly="" />
                                             ...
                                             <div class="span5">
                                                <div class="control-group">
                                                   ...
                                                   <div class="controls">
                                                      <div class="input-append">
                                                         <input type="text" id="clockface_endtime" value="14:30" name="etime" class="m-wrap small" readonly="" />
                                       ...
                                       <div class="control-group">
                                          ...
                                          <div class="controls">
                                             <input type="text" class="span6 m-wrap" name="venue"  placeholder="News/Event Place" />
                                          </div>
                                       </div>
                                       <div class="clearfix">&nbsp;</div>
                                    </div>
