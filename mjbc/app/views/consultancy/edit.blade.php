               ...
               <div class="row-fluid">
                  <div class="span12">
                     ...
                     <ul class="breadcrumb">
                        ...
                        <li><a href="#">Consultancy Edit</a></li>
                     </ul>
                  </div>
               </div>
            <!-- END PAGE HEADER-->
                  ...
                  <div class="span12">
                     <div class="portlet box blue" id="form_wizard_1">
                        <div class="portlet-title">
                           <h4>
                              <i class="icon-reorder"></i> Consultancy Edit <!-- - <span class="step-title">Step 1 of 3</span> -->
                           </h4>
                           
                        </div>
                        <div class="portlet-body form">
                           <form action="/updateconsultancy/{{$response->id}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                   ...
                                                   <ul>
                                                      <div class="gallery_container">
                                                         <li class="gallery_photo">
                                                             <img src="../../consultancy_photo/php/files/thumbnail/{{ $response->image}}"></img><span class="icon-cancel-circle">
                                                             <input type="hidden" value="{{ $response->image }}" name="gallery[]"></input></span>
                                                             <script>
                                                                 $(".gallery_photo").click(function(){$(this).remove();});
                                                               </script>
                                                           </li>
                                                        @foreach($response['consultancy_images'] as $row)
                                                              <li class="gallery_photo">
                                                                <img src="../../consultancy_photo/php/files/thumbnail/{{ $row->image}}"></img><span class="icon-cancel-circle">
                                          ...
                                          <div class="span10 " >
                                             ...
                                             <div>
                                                ...
                                                <span> + Select to Upload File </span>
                                                   <input name="pdf_file" id="pdf_file" type="file" size="" aria-required="true" value="{{ $response->download_file}}" />
                                                </div>
                                                      <div id="fileinfos">
                                                         <div id="filename">{{ $response->download_file }}</div>
                                                         <div id="filesize"></div>
                                                     </div>
                                                     <div id="warnsize" style="display:none;">Your file is very big. We can't accept it. Please select more small file</div>
                                                   <input type="hidden" value="{{ $response->download_file }}" name="hdfile">
                                                 </div>
