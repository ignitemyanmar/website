               ...
               <div class="row-fluid">
                  <div class="span12">
                     ...
                     <ul class="breadcrumb">
                        ...
                        <li><a href="#">Download TimeTable Update</a></li>
                     </ul>
                  </div>
               </div>
            <!-- END PAGE HEADER-->
                  ...
                  <div class="span12">
                     <div class="portlet box blue" id="form_wizard_1">
                        <div class="portlet-title">
                           <h4>
                              <i class="icon-reorder"></i> Download TimeTable Update <!-- - <span class="step-title">Step 1 of 3</span> -->
                           </h4>
                           
                        </div>
                        <div class="portlet-body form">
                           <form action="/updatedownloadtimetable/{{$download_tt->id}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="tab-content">
                                    <div class="tab-pane active" id="tab1">
                                       ...
                                       <div class="control-group">
                                          ...
                                          <div class="controls">
                                             <input type="text" class="span6 m-wrap" name="name" required placeholder="Timetable Name" value="{{ $download_tt->name}}" />
                                          </div>
                                       </div>
                                       <br>
                                       ...
                                       <div class="control-group">
                                          ...
                                          <div class="span10 " >
                                             ...
                                             <div>
                                                   ...
                                                   <input name="pdf_file" id="pdf_file" type="file" size="" aria-required="true" value="{{ $download_tt->file}}" />
                                                   </div>
                                                      <div id="fileinfos">
                                                         <div id="filename">{{ $download_tt->file }}</div>
                                                         <div id="filesize"></div>
                                                      </div>
                                                     <div id="warnsize" style="display:none;">Your file is very big. We can't accept it. Please select more small file</div>
                                                   <input type="hidden" value="{{ $download_tt->file }}" name="hdfile">
                                             </div>
                                          </div>
                                       </div>
