            ...
            <!-- BEGIN PAGE CONTENT-->
               <div class="row-fluid">
                  <div class="responsive span10" data-tablet="span8" data-desktop="span8">
                     <form id="addnew-form" class="horizontal-form" action = "/addlanguage" method= "post" enctype="multipart/form-data">    
                              ...
                              <div class="row-fluid">
                                 <div class="span10">
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input name="name" class="m-wrap span10" placeholder="Japan" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </div>
