...
@section('content')
    ...
    <div class="row" style="padding:6px 5px;">
          ...
          <div class="row listheader">
            <div class="large-2 columns"><div class="show-for-large-up">Image</div><div class="hide-for-large-up"><b>Sort By</b></div></div>
          ...
          @if(count($cars)>0)
            ...
            <div class="list-frame1">
              <div class="row carinfo-for-small">
                ...
                <div class="large-4 columns" style="min-height:62px;">
                    <div>
                      <a href="/buy-car/{{str_replace(' ','-',$row->category)}}/{{ $row->id}}/{{str_replace(' ','-',$row->make)}}/{{str_replace(' ','-',$row->model)}}"><span id="carlist_title">{{$row->make.' '. $row->model}}</span></a><br>
