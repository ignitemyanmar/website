...
<div class="large-10 columns">
	...
	<h2 class="title">Edit Ingredient</h2><br><br>
  		<form id="add_form" class="row custom" action = "/updateingredient/{{$ingredient->id}}" method= "post" enctype="multipart/form-data">
		
		
				<div class="row">
					<div class="large-2 column"><label for="title">Ingredient Name</label></div>
					<div class="large-10 column">
						<input name="name" type="text" required="required" value="{{$ingredient->name}}">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="large-10 column">
						<br>
						<a href="/ingredientlist" class="button round"> Cancel </a>
