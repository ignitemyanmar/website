...
<div class="large-10 columns">
	...
	<h2 class="title">Create New Advertisement</h2><br><br>
  		<form id="add_form" class="row custom panel addnew-form" action = "/addadvertisement" method= "post" enctype="multipart/form-data">
		...
		<div class="row">
			...
			<div class="large-9 column">
				<select name="position" id='position'>
					<option value="top-advertisement" selected>Top Advertisement</option>
					<option value="left-advertisement">Left Advertisement</option>
				</select>
			</div>
		</div><br>
