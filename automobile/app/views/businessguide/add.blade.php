...
<div class="large-10 columns">
	...
	<h2 class="title">Create New Business Guide</h2><br><br>
		<form id="add_form" class="row custom panel" action = "/addbusinessguide" method= "post" enctype="multipart/form-data">
		<div class="row">
		...
		<div class="row">
					<div class="large-3 column"><label for="image">Company Logo</label></div>
		...
		<div class="row">
			...
			<div class="large-9 column">
				<input name="township" type="text" required="required" >
			</div>
		</div>
